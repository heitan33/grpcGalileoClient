...
func serverStatJson(discInfoList []exporter.DiskInfo, deviceLinkingCountInt int64, numbers ...float64) string {
	serverStatItem := ServerStatItem{DiscInfoList: discInfoList, DeviceLinkingCountInt: deviceLinkingCountInt, DiscReadFloat: numbers[0], DiscWriteFloat: numbers[1], MemoryUsageRate: numbers[2], CpuUsageRate: numbers[3], Load: numbers[4], BandwidthUpload: numbers[5], BandwidthDownload: numbers[6], IopsRead: numbers[7], IopsWrite: numbers[8]}
...
//		var number int64 = 20
		...
		pioNumber := &Number
		pioNumber.CpuUsageRate = 50
		pioNumber.MemoryUsageRate = 80
		pioNumber.DiskUsage = 80
		pioNumber.Load = 80
		pioNumber.DiscRead = 1000
		pioNumber.DiscWrite = 1000
		pioNumber.IopsRead = 1000
		pioNumber.IopsWrite = 1000
		pioNumber.DeviceLinkingCount = 10
